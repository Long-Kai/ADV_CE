"""
**** This filed is modified from https://github.com/ShuoYang-1998/Few_Shot_Distribution_Calibration/blob/master/FSLTask.py
"""
import os
import pickle
import numpy as np
...
# ========================================================
#   Usefull paths
_datasetFeaturesFiles = {"miniImagenet": "./data/im/novel_features.plk",
                         "miniImagenet_val": "./data/im/val_features.plk"}
_cacheDir = "../data/im/cache"
_maxRuns = 10000
_min_examples = -1
